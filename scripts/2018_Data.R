...
# Read the Excel file
data_left <- read_excel("~/Downloads/Pie_chart_2018.xlsx", sheet = "Exclusion Criteria")
data_middle <- read_excel("~/Downloads/Pie_chart_2018.xlsx", sheet = "Estimation Equations")
